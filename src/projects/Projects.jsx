...
const projects = [
  {title: 'Portfolio Website', img: PortfolioImage, description: "A professional website for my portfolio where I can introduce myself and highlight my abilities and experiences", technical: "React, Vite, HTML, CSS, Tailwind css, Framer"},
...
export default function Projects() {
  return (
    <motion.div className='primary-bg'>
      <Navbar></Navbar>
