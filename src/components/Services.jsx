...
export default function Services() {
    ...
    return (
        <div className='box'>
            ...
            <div className='grid grid-cols-1 mx-auto gap-10 w-11/12 md:w-10/12 text-left md:grid-cols-2 lg:grid-cols-3'>
                <div className={'rounded-[15px] border-2 border-white shadow-sm shadow-neutral-700 p-[2em]'} style={active === 0 ? {
                    background: "linear-gradient(to right, var(--primary-accent-color) 0%,rgba(160,77,239, 0.6) 100%)", border: "1px solid black"
                ...
                <div className='rounded-[15px] border-2 border-white shadow-sm shadow-neutral-700 p-[2em]' style={active === 1 ? {
                    background: "linear-gradient(to right, var(--primary-accent-color) 0%,rgba(160,77,239, 0.6) 100%)", border: "1px solid black"
                ...
                <div className='rounded-[15px] border-2 border-white shadow-sm shadow-neutral-700 p-[2em]' style={active === 2 ? {
                    background: "linear-gradient(to right, var(--primary-accent-color) 0%,rgba(160,77,239, 0.6) 100%)", border: "1px solid black"
