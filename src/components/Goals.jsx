...
export default function Goals() {
    ...
    return (
        <div className=' w-8/12 mx-auto box my-5 secondary-color p-[3em]'>
            ...
            <div className='grid grid-rows-5 grid-cols-2 md:grid-cols-10 gap-[5em] p-5 secondary-color font-extrabold'>
                <div className='col-start-2  mx-auto md:w-full bg-[#ec5656d3] md:col-start-5 md:col-span-4 row-start-1 rounded-lg first'>
                    <p className='p-7 '>start a professional software developer position in the US</p>
                </div>
                <div className='col-start-1  row-start-2 md:col-start-3 md:col-span-4  bg-[#df16e2c0] rounded-lg second'>
                    <p className='p-7 '>Upgrading my computer science skills by learning design patterns.</p>
                </div>
                <div className='col-start-2 row-start-3 md:col-start-4 md:col-span-4  bg-[#52d0aac4] rounded-lg first'>
                ...
                <div className='row-start-5 col-start-2  bg-[#c76c57ec] md:col-start-2 md:col-span-4 rounded-lg third'>
