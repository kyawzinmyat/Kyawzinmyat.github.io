...
import { FullScreen } from '@syncfusion/ej2/richtexteditor'
        ...
        <div className='box py-[2em] primary-color' ref={ref}>
            <div className='md:w-8/12 w-10/12 mx-auto text-center about-me-container' style={{
                ...
                <div className='grid md:grid-cols-2 grid-cols-1 my-[4em] md:gap-10 gap-y-10'>
                    <motion.div className='transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 secondary-bg primary-color rounded-[5px] md:col-span-2 shadow-lg'>
                        ...
                        <hr></hr>
                        <div className='font-md text-sm md:text-md xl:px-[12em] lg:p[5em] p-[3em]'>
                    ...
                    <div className='transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 secondary-bg primary-color rounded-[5px] shadow-lg'>
                        <h1 className='text-center text-lg md:text-2xl font-bold my-3'>Personal</h1>
                        <hr></hr>
                    ...
                    <div className='transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 secondary-bg primary-color rounded-[5px] shadow-lg'>
                        <h1 className='text-lg md:text-2xl font-bold my-3'>Education</h1>
                        <hr></hr>
