...
const technical = [
    ['Python', PythonImage], ['Django/Rest', DjangoImage], ['Odoo', PythonImage],
    ['PostgreSQL', PythonImage], ['Mongodb', PythonImage],
...
export default function TechnicalStacks() {
    ...
    var opacity = useTransform(scrollYProgress, [0.5, 0.8], [1, 0])
